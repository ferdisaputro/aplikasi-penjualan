...
@section('container')
   <main class="container py-3">
      ...
      <section>
         <form action="/produk" method="POST" class="py-2 col-11 mx-auto">
            @csrf
            <h3 class="text-center">Tambah produk</h3>
            <div class="row row-cols-md-2">
               <div class="col">
                  <div class="input-group has-validation mb-3">
                     <input type="text" id="kode_produk" name="kode_produk" value="{{ old('kode_produk')?? $produks->first()->kode_produk + 1 }}" class="form-control @error('kode_produk')
                        is-invalid
               ...
               <div class="col">
                  <div class="input-group has-validation mb-3">
                     <input type="text" id="nama_produk" name="nama_produk" value="{{ old('nama_produk') }}" class="form-control @error('nama_produk')
                        is-invalid
               ...
               <div class="col">
                  <div class="input-group has-validation mb-3">
                     <input type="text" id="harga" name="harga" value="{{ old('harga') }}" class="form-control currency-input @error('harga')
                        is-invalid
               ...
               <div class="col">
                  <div class="row">
                     <div class="col">
                        <div class="input-group has-validation mb-3">
                           <input type="number" id="stok" name="stok" value="{{ old('stok')?? '0' }}" min="0" placeholder="0" class="form-control @error('stok')
                              is-invalid
                           @enderror" value="08">
                     ...
                     <div class="col">
                        <div class="input-group has-validation mb-3">
                           <select type="number" id="satuan" name="satuan" value="{{ old('satuan') }}" placeholder="0" class="form-select @error('satuan') is-invalid @enderror" value="08">
      ...
      @include('partials.produk.produk')
   </main>
@endsection